		...
		<div class="flex-w flex-sb">
			<div class="w-size13 p-t-30 respon5">
				<div class="wrap-slick3 flex-sb flex-w">
					...
					<!-- <div class="slick3">
						<div class="item-slick3" data-thumb="images/tshirt-front-black.jpg">
							<div class="wrap-pic-w">
			...
			<div class="w-size14 p-t-30 respon5">
                ...
                Baju berbahan katun dengan teknologi water-proof berwarna Hitam.
                </p> -->
                <div class="p-b-5 p-t-20">
					<span class="s-text9 m-r-35">SKU: TS-02</span><br>
					<span class="s-text9">Categories: Top, Waterproof</span>
				</div>
				...
				<div class="wrap-dropdown-content bo6 p-t-15 p-b-14 active-dropdown-content">
					...
					<div class="dropdown-content dis-none p-t-15 p-b-23">
						<p class="s-text8">
                        Baju berbahan katun dengan teknologi water-proof berwarna Abu - abu.
                        </p>
					</div>
				</div>
				...
				<div class="wrap-dropdown-content bo7 p-t-15 p-b-14">
					...
					<div class="dropdown-content dis-none p-t-15 p-b-23">
						<p class="s-text8">
                            If the size that you want is not there, it means you have to order through Pre-Order from our Customer Services.
                        </p>
					</div>
				</div>
