...
<body class="animsition">
	...
	<!-- Title Page -->
	<section class="bg-title-page p-t-40 p-b-50 flex-col-c-m" style="background-image: url(images/collection_header.jpg); filter: brightness(80%);">
							...
							<div class="item-blog-txt p-t-33">
								<h4 class="p-b-11">
									<a href="#" class="m-text24">
										Release Soon : New Collection of Mbocuan Project
									</a>
								</h4>
								...
								<p class="p-b-12">
									This new project coming up. Brace yourself to enjoy the brand new Collection of fashion based in Surabaya. With a innovative technologies of Water-Proof Clothes that comfy the user and have casual looks.
								</p>
							</div>
						</div>
					...
					<div class="rightbar">
						...
						<ul>
							<li class="p-t-6 p-b-8 bo6">
								<a href="product.php" class="s-text13 p-t-5 p-b-5">
									Collection
								</a>
							</li>
						...
						<h4 class="m-text23 p-t-65 p-b-34">
						 ...
						 <ul class="bgwhite">
							<li class="flex-w p-b-20">
								<a href="product-detail-black-tshirt.html" class="dis-block wrap-pic-w w-size22 m-r-20 trans-0-4 hov4">
									<img src="images/tshirt-front-black.jpg" alt="IMG-PRODUCT">
								</a>

								<div class="w-size23 p-t-5">
									<a href="product-detail-black-tshirt.html" class="s-text20">
							...
							<li class="flex-w p-b-20">
								<a href="product-detail-red-tshirt.html" class="dis-block wrap-pic-w w-size22 m-r-20 trans-0-4 hov4">
									<img src="images/tshirt-front-red.jpg" alt="IMG-PRODUCT">
								</a>

								<div class="w-size23 p-t-5">
									<a href="product-detail-red-tshirt.html" class="s-text20">
							...
							<li class="flex-w p-b-20">
								<a href="product-detail-white-tshirt.html" class="dis-block wrap-pic-w w-size22 m-r-20 trans-0-4 hov4">
							...
							<li class="flex-w p-b-20">
								<a href="product-detail-gray-tshirt.html" class="dis-block wrap-pic-w w-size22 m-r-20 trans-0-4 hov4">
									<img src="images/tshirt-front-gray.jpg" alt="IMG-PRODUCT">
								</a>

								<div class="w-size23 p-t-5">
									<a href="product-detail-gray-tshirt.html" class="s-text20">
