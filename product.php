...
<body class="animsition">
		...
		<div class="container-menu-header">
			...
			<div class="wrap_header">
				...
				<div class="header-icons">
					<a href="about" class="header-wrapicon1 dis-block">
	...
	<!-- Title Page -->
	<section class="bg-title-page p-t-50 p-b-40 flex-col-c-m" style="background-image: url(images/collection_header.jpg);">
		<h2 class="l-text2 t-center">
			Collection
		</h2>
		<p class="m-text13 t-center">
			New Arrivals Collection 2020
		</p>
	</section>
	...
	<script type="text/javascript">
		$('.block2-btn-addcart').each(function(){
			...
			$(this).on('click', function(){
				var n = nameProduct.includes("Black T-Shirt");
				if(n == true){
					swal(nameProduct,"Baju berbahan katun dengan teknologi water-proof berwarna Hitam", "success");
				}
				var n = nameProduct.includes("White T-Shirt");
				if(n == true){
					swal(nameProduct,"Baju berbahan katun dengan teknologi water-proof berwarna Putih", "success");
				}
				var n = nameProduct.includes("Grey T-Shirt");
				if(n == true){
					swal(nameProduct,"Baju berbahan katun dengan teknologi water-proof berwarna Abu - Abu", "success");
				}
				var n = nameProduct.includes("Red T-Shirt");
				if(n == true){
					swal(nameProduct,"Baju berbahan katun dengan teknologi water-proof berwarna Merah", "success");
				}
			});
		...
		$('.block2-btn-addwishlist').each(function(){
			var nameProduct = $(this).parent().parent().parent().find('.block2-name').html();
			$(this).on('click', function(){
				swal(nameProduct, "Thanks for your rate(s)", "success");
			});
		});
	</script>
